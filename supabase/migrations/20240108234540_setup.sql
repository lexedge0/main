...
AS $$
DECLARE
  project_url TEXT := 'https://beuidiovcliwgiutpomk.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJldWlkaW92Y2xpd2dpdXRwb21rIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzQzOTM4MCwiZXhwIjoyMDIzMDE1MzgwfQ.p3hb4iCqhA5wkwrzs5qwn416VFa5wfrrXgA7tgJouPg'; -- full access needed for http request to storage
